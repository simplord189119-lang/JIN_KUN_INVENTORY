export const WEAPONS = [
  ...
  { id: 'sig_jiyan', name: 'Verdant Summit', type: 'Broadblade', rarity: 5, image: '' }, // Jiyan


  { id: 'sig_qiuyuan', name: 'Emerald Sentence', type: 'Sword', rarity: 5, image: '' }, // Qiuyuan
  ...
  // Electro
  { id: 'sig_augusta', name: 'Thunderflare Dominion', type: 'Broadblade', rarity: 5, image: '' }, // Augusta
  ...
  // Fusion
  { id: 'sig_aemeath', name: 'Everbright Polestar', type: 'Sword', rarity: 5, image: '' }, // Aemeath


  { id: 'sig_changli', name: 'Blazing Brilliance', type: 'Sword', rarity: 5, image: '' }, // Changli
  ...
  // Spectro
  { id: 'sig_jinhsi', name: 'Ages of Harvest', type: 'Broadblade', rarity: 5, image: '' }, // Jinhsi
  ...
  { id: 'sig_shorekeeper', name: 'Stellar Symphony', type: 'Rectifier', rarity: 5, image: '' }, // The Shorekeeper

  { id: 'sig_zani', name: 'Blazing Justice', type: 'Gauntlets', rarity: 5, image: '' }, // Zani
];
